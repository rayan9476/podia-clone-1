...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // animation gallery-section2 //

  gsap.to(".animate-gallery-items2 ", {
    opacity: 1,
    y: 0,
    duration: 0.8,
    ease: "power3.out",
  ...
  // growing-you-business-is-a-simple-list-animate //

  gsap.to(".animate-business-section-list-items", {
    opacity: 1,
    y: 0,
    duration: 0.8,
    ease: "power3.out",
    ...
    scrollTrigger: {
      trigger: ".animate-business-section",
      start: "top 95%",
      end: "bottom 90%",
      scrub: true,
      markers: false,
  ...
  // Leave-the-technical-stuff-to-us-list-animate //

  gsap.to(".animate-technical-stuff-list-items", {
    opacity: 1,
    y: 0,
    duration: 0.8,
    ease: "power3.out",
    ...
    scrollTrigger: {
      trigger: ".Leave-the-technical-stuff-to-us-list",
      start: "top 95%",
      end: "bottom 90%",
      scrub: true,
      markers: false,
  ...
  // aniamte-list-item-all-the-features-that-you-need-section //
  ...
  gsap.to(".animate-online-store-items ", {
    opacity: 1,
    y: 0,
    duration: 0.8,
    ease: "power3.out",
...
function toggleSubnav() {
  ...
  if (isHidden) {
    // It currently hidden → now opening
